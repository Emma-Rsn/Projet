\chapter{The Last Nightmare}
\hypertarget{md_README}{}\label{md_README}\index{The Last Nightmare@{The Last Nightmare}}
\label{md_README_autotoc_md0}%
\Hypertarget{md_README_autotoc_md0}%
 \hypertarget{md_README_autotoc_md1}{}\doxysection{\texorpdfstring{PROJET DE FIN D\textquotesingle{}\+ETUDES L2 INFORMATIQUE 2023-\/2024}{PROJET DE FIN D'ETUDES L2 INFORMATIQUE 2023-2024}}\label{md_README_autotoc_md1}
{\bfseries{The Last Nightmare}} est un projet réalisé par trois étudiants de L2 d’\+Informatique à l’\+Université du Mans.

Le jeu est un {\itshape rogue-\/lite RPG} en monde semi-\/ouvert et avec des combats en tour par tour. Inspiré des jeux {\itshape Darkest Dungeon} pour les combats et la gestion et de {\itshape Pokémon} pour le monde semi-\/ouvert et la partie {\itshape RPG}.
...
\href{https://docs.google.com/spreadsheets/d/1ztj0WcCh9m7Oyz1d7LtRVNm7JXvxKlheRPS5YPnYCNk/edit?usp=sharing}{\texttt{ Lien Gantt}} 