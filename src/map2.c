...
int creer_map(map_t * map){
    ...
    if(xZone1==3&&yZone1==2){
        ...
        choix=rand() % 5;
        switch(choix){
            //Cas si on rempli que de la zone foret
            case 0:
            for(x=4;x<ROWS;x++){
                for(y=2;y<COLUMNS;y++){
                    if(map->tabMap[x][y].nZone==0){
                        map->tabMap[x][y].nZone=4;
                    }
                }
            }
            break;
            ...
            break;
            //Cas si on rempli que de la zone plage
            case 4:
            for(x=4;x<ROWS;x++){
                for(y=2;y<COLUMNS;y++){
                    if(map->tabMap[x][y].nZone==0){
        ...
        choix=rand() % 4;
        switch(choix){
            //Cas si on rempli que de la zone grotte
            case 0:
            map->tabMap[2][0].nZone=5;
            map->tabMap[2][1].nZone=5;
            map->tabMap[3][0].nZone=5;
            break;
            case 1:
            //Cas si on rempli 1 case de la zone foret et 2 de la zone grotte
            choix2=rand() % 2;
            //Première possibilité de remplissage
            if(choix2==0){
                map->tabMap[2][0].nZone=5;
            ...
            break;
            //Cas si on rempli 2 case de la zone foret et 1 de la zone grotte
            case 2:
            choix2=rand() % 3;
            //Première possibilité de remplissage
            if(choix2==0){
